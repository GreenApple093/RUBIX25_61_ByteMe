...
const RollingGallery = ({ autoplay = false, pauseOnHover = false, images = [] }) => {
  ...
  const cylinderWidth = isScreenSizeSm ? 800 : 1600; // Adjust for small screens
    ...
    <div className="relative-container">
      ...
      <div className="flex h-full items-center justify-center [perspective:1000px]">
        <motion.div
          ...
          animate={controls}
          onUpdate={({ rotateY }) => rotation.set(rotateY)}
          style={{
            transform: transform,
            rotateY: rotation,
            width: cylinderWidth,
          ...
          {images.map((url, i) => (
            ...
            >
              <img
                src={url}
                alt="gallery"
                className="h-[150px] w-[300px] rounded-[15px] border-[3px] border-white object-cover
