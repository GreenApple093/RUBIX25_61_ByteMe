...
const Chest = () => {
  ...
  return (
    <div className="bg-gradient-to-r from-red-950 to-black py-20 text-white flex items-center justify-center">
        ...
        <div className="flex justify-center items-center">
          ...
          >
            {slides.map((slide, index) => (
              ...
              >
                <div className="relative h-[400px] bg-white border-4 border-white shadow-lg rounded-lg">
                  <img
                    src={slide.image}
                    alt={slide.title}
                    className="w-[250px] h-[300px] object-cover rounded-lg"
                  />
                  <h2 className="absolute bottom-10 left-0 w-full bg-white text-center font-bold text-xl p-2 rounded-b-lg text-black">
                    {slide.title}
                  </h2>
                  <h4 className="absolute bottom-2 left-0 w-full bg-white text-center font-bold text-sm p-2 rounded-b-lg text-black">
                    {slide.tag}
                  </h4>
                </div>
              </SwiperSlide>
